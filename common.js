// ============================================================
// SERVER_IP vient maintenant de data.js (édité via /admin.html),
// donc on n'importe plus ni l'IP ni le lancement du statut avant
// que les données soient chargées (onSiteDataReady).
// ============================================================
